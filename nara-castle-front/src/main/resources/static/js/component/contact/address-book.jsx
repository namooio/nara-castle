...
AddressContent.url = {
    //
    FIND_ADDRESS_BOOK: `${Constant.PAV_CTX_API}/api/castellans/{id}/contacts/address-book`,
    ATTACH_PHONE_BOOK: `${Constant.PAV_CTX_API}/api/castellans/{id}/contacts/address-book`
};
