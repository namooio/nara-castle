...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Const = exports.Ajax = exports.Date = exports.Object = undefined;
	...
	exports.Const = constantPublicNamespace;
	exports.default = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Dom = exports.Const = undefined;
	...
	(function () {
	    ...
	    exports.Const = constPublicNamespace = {};
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _reactRouter.Link,
	                            { activeClassName: 'navbar-brand', to: _castleCommon.Const.PAV_CTX_HASH + '/' },
	                            'Castle'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    _reactRouter.Link,
	                                    { to: _castleCommon.Const.PAV_CTX_HASH + '/castles' },
	                                    MENUS.castles[lang]
	                                )
	                            ),
	                            _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RolePlayerPop = function (_Component) {
	    ...
	    _createClass(RolePlayerPop, [{
	        ...
	        key: 'roleCheckChange',
	        value: function roleCheckChange(playerIndex, roleIndex, event) {
	            console.log('i:' + playerIndex + ', j:' + roleIndex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CastleListPage = function (_Component) {
	    ...
	    _createClass(CastleListPage, [{
	        ...
	        value: function requestFindCastles(castleCriteria) {
	            //
	            _naraCommon.Ajax.getJSON(CastleListPage.FIND_CASTLES_URL).done(function (castlesResult) {
	...
	CastleListPage.FIND_CASTLES_URL = _castleCommon.Const.PAV_CTX_API + '/api/castles';
	                                ...
	                                existsCastle === true ? this.props.castles.map(function (castle, index) {
	                                    ...
	                                    return _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                _reactRouter.Link,
	                                                { to: _castleCommon.Const.PAV_CTX_HASH + '/castle/' + castle.id + '/basic' },
	    ...
	    _createClass(Tab, [{
	        ...
	        value: function render() {
	            ...
	            var contentType = this.props.contentType,
	                baseLinkUrl = _castleCommon.Const.PAV_CTX_HASH + '/castle/' + this.props.castleId;
...
/***/ function(module, exports, __webpack_require__) {
	...
	BasicContent.url = {
	    //
	    FIND_CASTLE: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}',
	    FIND_CASTELLAN: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}',
	    MODIFY_NAME: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/name',
	    MODIFY_LOCALE: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/locale',
	    SUSPEND_CASTLE: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/suspend',
	    REOPEN_CASTLE: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/reopen',
	    MODIFY_PRIMARY_EMAIL: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/primary-email',
	    MODIFY_PRIMARY_PHONE: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/primary-phone',
	    FIND_NAME_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/name-book',
	    FIND_EMAIL_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/email-book',
	    FIND_PHONE_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/phone-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	NameContent.url = {
	    //
	    FIND_NAME_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/name-book',
	    ATTACH_NAME_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/name-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	PhoneContent.url = {
	    //
	    FIND_PHONE_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/phone-book',
	    ATTACH_PHONE_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/phone-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	EmailContent.url = {
	    //
	    FIND_EMAIL_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/email-book',
	    ATTACH_EMAIL_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/email-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	AddressContent.url = {
	    //
	    FIND_ADDRESS_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/address-book',
	    ATTACH_PHONE_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castellans/{id}/contacts/address-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	AccountContent.url = {
	    //
	    FIND_ACCOUNT_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/histories/account-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	StateContent.url = {
	    //
	    FIND_STATE_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/histories/state-book'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	MetroContent.url = {
	    //
	    FIND_METRO_BOOK: _castleCommon.Const.PAV_CTX_API + '/api/castles/{id}/histories/metro-book'
	};
