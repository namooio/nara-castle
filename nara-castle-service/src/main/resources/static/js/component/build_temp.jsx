...
( function () {
    ...
    let CastellanRegisterer = React.createClass({
        ...
        registerBtnClick: function () {
            ...
            CastleCommon.postJSON(CastleConst.CTX + '/front/castellan', castellanCreateDto)
                .done(function () {
    ...
    Components.Castellan.Registerer.renderLayout = function () {
        ReactDOM.render(<CastellanRegisterer />, CastleCommon.getContentsJDom());
    };

    Components.Castellan.Registerer.renderLayout();
})();
